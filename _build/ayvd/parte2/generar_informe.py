...
<div class="card">
  ...
  <div class="formula">$$\\widehat{{\\Delta}} = {fmt_ars(mediaA)} - {fmt_ars(mediaB)} = {fmt_ars(delta_hat)}$$</div>
</div>
...
<div class="card">
  ...
  distintas ($s_A = {fmt_ars(sA)}$, $s_B = {fmt_ars(sB)}$), el IC se
  construye con el procedimiento de <b>Welch</b> usando los grados
  de libertad de <b>Satterthwaite</b>:</p>
